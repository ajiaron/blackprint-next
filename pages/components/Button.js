...
const Button = ({type, onHandlePayment, onHandleBooking}) => {
    ...
    return (
        ...
        className={`button-container-${type==="package"?"alt-":type==="booking"?"booking-":""}v2`}
        >
            <div className={`button-content-${type==="package"?"alt-":type==="booking"?"booking-":""}v2`}>
                {(type!=="booking")&&
                <div className={`button-icon-${type==="package"||type==="booking"?"alt-":""}v2`}>
                ...
                <p className={`button-text-${type==="package"||type==="booking"?"alt-":""}v2`}>
